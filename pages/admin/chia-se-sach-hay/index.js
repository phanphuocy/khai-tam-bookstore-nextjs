...
const StyledPanel = styled.div`
  ...
  .top-actions {
    ...
    padding: ${({ theme }) => `0 ${theme.spacing["4"]} ${theme.spacing["6"]}`};

    button.top-actions__create-new-btn {
      ${({ theme }) => theme.borderRadius["rounded"]};
      ...
      border-bottom: ${({ theme }) => `1px solid ${theme.colors.green["200"]}`};
    ...
    <AdminLayout>
      <StyledPanel>
        <div className="top-actions">
          <button
            className="top-actions__create-new-btn"
            onClick={() => router.push("/admin/chia-se-sach-hay/tao-moi")}
          >
